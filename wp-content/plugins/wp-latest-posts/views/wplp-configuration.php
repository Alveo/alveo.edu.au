...
webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> <p><a href="http://vimeo.com/77775570">';
            ...
            echo '<li><img src="' .
                plugins_url('img/gridtheme.png', dirname(__FILE__)) . '" alt="JoomUnited Logo" /></li>';
            echo '<li><img src="' .
                plugins_url('img/categorygrid.png', dirname(__FILE__)) . '" alt="JoomUnited Logo" /></li>';
            echo '<li><img src="' .
                plugins_url('img/smoothhover.png', dirname(__FILE__)) . '" alt="JoomUnited Logo" /></li>';
            echo '<li><img src="' .
                plugins_url('img/timeline.png', dirname(__FILE__)) . '" alt="JoomUnited Logo" /></li>';
            echo '</ul></div>';
